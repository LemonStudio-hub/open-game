...
impl Profiler {
    pub fn new(max_frame_history: usize) -> Self {
        Self {
            scopes: HashMap::new(),
            frame_times: Vec::with_capacity(max_frame_history),
            max_frame_history,
    ...
    pub fn report(&self) -> ProfileReport {
        let frame_time_ms = self.frame_times.last().copied().unwrap_or(0.0) / 1000.0;
    ...
    pub fn frame_time_ms(&self) -> f32 {
        self.frame_times.last().copied().unwrap_or(0.0) / 1000.0
    }
